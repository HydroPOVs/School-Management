...
class Faculty:
    ...
    def resultentry(self, db):
        ...
        db = database.initialize()
        cursor= db.cursor()
        st2= "UPDATE Student_marks SET Marks_in_subject_1 = {}, Marks_in_subject_2 = {}, Marks_in_subject_3 = {}, Marks_in_subject_4 = {}, Marks_in_subject_5 = {}, Percentage = {}, Overall = '{}' WHERE Roll_no = {} ".format(ms1, ms2, ms3, ms4, ms5, p, ov, roll)
        cursor.execute(st2)
        db.commit()
        db.close()
